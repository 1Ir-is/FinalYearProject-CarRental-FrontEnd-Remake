              ...
              <form action="#" method="post" encType="multipart/form-data">
                ...
                <div className="row gx-3 mb-3">
                    <div className="col-md-6">
                        ...
                        <input className="form-control" id="fullName" name="Name" type="text" placeholder="Enter your name" value={user.name} />
                    </div>
                    <div className="col-md-6">
                    ...
                    <div className="col-md-6">
                        ...
                        <input className="form-control" id="mobile" name="phone" type="text" placeholder="Enter your phone number" value={user.phone}  />
                    </div>
                    <div className="col-md-6">
                        <label className="small mb-1" htmlFor="fullAddress">Address</label>
                        <input className="form-control" id="fullAddress" name="address" type="text" placeholder="Enter your address" value={user.address}  />
                    </div>
                    </div>
                    <div className="row gx-3 mb-3">
                    <div className="col-md-6">
